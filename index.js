...
audio20 = fs.readFileSync('./X3/nayla20.m4a') 
		...
		//	if (nay.key.fromMe) return
            ...
            if (isBanned) return reply("MAAF ANDA TELAH DI BANNED") 			 
         	...
         	.on('end', function () {
         	console.log('SELESAI JANGAN LUPA SUBSCRIBE YT DELL GANZ')
			...
			reply('SUKSES!!!, JGN LUPA SUBSCRIBE https://youtube.com/channel/UCzAjp7STAQE7Omu-mkf30Wg')
			} catch {
			reply('LINK ERROR!')
			}
			break			  	
...
⚯⚯⚯⚯⚯⚯⚯⚯⚯⚯⚯`    
            ...
            {buttonId: 'id3', buttonText: {displayText: `OWNER GANZ`}, type: 1}]
